...
class AnnoyingCrap(object):
    ...
    def getTheColumns():
        return [
            ...
            {"name": 'Mine', "id": 'mineralSalesScore', "deletable": False, "selectable": False, "hideable": True, "type": "numeric"},
            {"name": 'BH', "id": 'bountyHuntingScore', "hideable": True, "hidden": True, "type": "numeric"},
            {"name": 'SM', "id": 'smugglingScore', "hideable": True, "hidden": True, "type": "numeric"},
